        ...
        ui.add(bg_panel).nest(|| {
            ui.add_component(transform).nest(|| {
                ui.add(V_STACK).nest(|| {
                    ...
                    ui.add(H_STACK).nest(|| {
                        ui.add(PANEL.color(RED).size_symm(Size::Pixels(50.0)));
                        ui.add(PANEL.color(GREEN).size_symm(Size::Pixels(50.0)));
                        ui.add(PANEL.color(BLUE).size_symm(Size::Pixels(50.0)));
                    });
