...
pub(crate) const COMPONENT_ROOT: Node = Node {
    animation: Animation { speed: 1.0, enter: EnterAnimation::None, exit: ExitAnimation::None, state_transition: StateTransition { animate_layout: true, animate_properties: false } },
    key: None,
    children_layout: ChildrenLayout::Free,
    text_options: TextOptions::const_default(),
    visible: false,
